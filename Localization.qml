...
Item {
	...
	property var localization: {
		"en": {
			...
			settings_force_home: "Force to Home on Return",
			settings_force_home_info: "Makes you go to the home page upon closing a game, rather than returning to where you were.",
